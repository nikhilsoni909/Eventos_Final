...
<body>  
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="message-box">
                        ...
                        <h4>${event.eventCity}, ${event.eventDateTime}</h4>
    ...
    document.getElementById('powerBtn').scrollIntoView({
        ...
        function createTicketCategories() {
            ...
            // Using a for loop to iterate over the ticketTypes array
          for (var i = 0; i < ticketTypes.length; i++) {
                var ticketType = ticketTypes[i];
                console.log("Ticket Type ID: " + ticketType.ticketId);
                console.log("Event ID: " + ticketType.eventId);
                console.log("Ticket Type: " + ticketType.ticketType);
                console.log("Ticket Price: " + ticketType.ticketPrice);
                console.log("Ticket Quantity: " + ticketType.ticketQuantity);
                ...
                avilableElement.classList.add('col-md-3', 'text-right');
                avilableElement.innerHTML = '<span class="font-weight-bold">avilable: ' + ticketType.ticketQuantity + '</span>';
